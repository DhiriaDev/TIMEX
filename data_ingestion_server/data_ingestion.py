...
def ingest_timeseries(param_config: dict, data_set):
    ...
    try:
        ...
        df_ingestion = pd.read_csv(StringIO(data_set.decode()), usecols=columns_to_read)[columns_to_read]

    except (KeyError, ValueError):
        df_ingestion = pd.read_csv(data_set)
