...
class SeasonalPersistenceModel(PredictionModel):
    ...
    def predict(self, train_data: DataFrame, points_to_predict: int,
        ...
        future_dataframe.loc[index_to_update, 'yhat_upper'] = y_hat_df.loc[:, 'SeasonalNaive-hi-95']
        future_dataframe.loc[index_to_update, 'yhat_lower'] = y_hat_df.loc[:, 'SeasonalNaive-lo-95']
